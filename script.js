...
function searchResultBuilder() {
  ...
  req3.onreadystatechange = function() {
      ...
      if (dataThree.totalCount >= 1) {
        ...
        let divContainer = document.createElement('div');
        divContainer.setAttribute('class','div-container-no-results');
        containerOne.appendChild(divContainer);
        divContainer.innerHTML = "No Results Found";
        //If the API returns 0 results the message above will appear.
      }
  ...
  req1.open('GET', 'https://cors-anywhere.herokuapp.com/https://jobs.github.com/positions.json?description=' + descriptionInput.value + '&location=' + locationInput.value);
